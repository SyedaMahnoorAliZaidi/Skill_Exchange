...
const Plumbing: React.FC = () => {
  ...
  const fetchPlumbingServices = async () => {
    try {
      ...
      // Fetch plumbing services by category
      ...
      const plumbingServices = response.data;

      setServices(plumbingServices);
    } catch (err: any) {
      console.error("Error fetching plumbing services:", err);
      setError(err.response?.data?.message || "Failed to fetch plumbing services");
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Find expert plumbers and plumbing professionals in your area. From pipe repairs to installations, 
            get reliable plumbing solutions with our skilled technicians.
          </p>
        </div>
        ...
        <div className="mb-8">
          <HeaderFilter
            heading={`${filteredServices.length} Plumbing Services Available`}
            subHeading="Professional plumbers and plumbing experts ready to serve you"
            onClickTab={() => {}}
          />
          ...
          {loading && (
            <div className="text-center py-12">
              ...
              <p className="mt-2 text-gray-600">Loading plumbing services...</p>
            </div>
          )}
          ...
          {!loading && !error && filteredServices.length === 0 && (
            <div className="text-center py-12">
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-8">
                <h3 className="text-xl font-semibold text-gray-900 mb-2">No Plumbing Services Found</h3>
                <p className="text-gray-600 mb-4">
                  {searchTerm || selectedCity 
                    ? "Try adjusting your search criteria or filters."
                    : "No plumbing services are currently available in your area."
                  }
                </p>
                {(searchTerm || selectedCity) && (
                  <ButtonPrimary 
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-center text-white mb-8">
          <p className="text-xl mb-6 opacity-90">Can't find what you're looking for? Contact us to connect with more plumbing professionals.</p>
